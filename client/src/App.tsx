            ...
            <div className="flex-1 flex items-center justify-center gap-4">
              ...
              {user && (
                <Link 
                  ...
                  className={`text-sm font-medium transition-colors relative ${location.includes("/profile/") ? "font-bold bg-black text-white after:scale-x-100 after:bg-teal-500 after:h-[2px]" : "hover:after:scale-x-100 hover:text-primary/90"} after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-primary after:scale-x-0 after:transition-transform px-4 py-2 rounded-t-md`}
                >
                  My Profile
                </Link>
              )}
