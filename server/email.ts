 ...
 * In a real production environment, you would use a proper SMTP service
 */
export function initEmailService() {
  // For testing/development, use a mock/preview mode
  ...
  if (process.env.EMAIL_HOST && 
    ...
    // Use Ethereal for testing/preview
    console.log('Using Ethereal Email for testing. Email links will be logged to console.');
